...
- [ ] Deploy to a free static host — not done yet, blocked on which host/account to use and whether a GitHub repo exists to connect; needs the user
- [ ] Share the live URL — blocked on the above
